  ...
  return (
    <>
      <div className="settingsContainer d-flex flex-column align-items-center">
        ...
        <main className="settingsContainer__main d-flex flex-column align-items-center gap-3 my-3">
          <header className="settingsContainer__main__mainHeader d-flex flex-row align-items-center">
            <Link to={"/UserManageProfile"}>            
              <button className="settingsContainer__main__mainHeader__btn">
                <i className="fa-solid fa-arrow-left"></i>
              </button>
            </Link>

            <div className="settingsContainer__main__mainHeader__topNameDiv justify-self-center">
              <h2>
          ...
          <div className="settingsContainer__main__contentContainer">
            <div className="settingsContainer__main__contentContainer__content d-flex flex-row justify-content-between align-items-center">
            ...
            <div className="settingsContainer__main__contentContainer__content d-flex flex-row justify-content-between align-items-center">
              <div className="d-flex flex-row align-items-center gap-2 flex-grow-1">
                ...
                <div className="d-flex flex-column">
                  ...
                  <p>
                    Add personal pin to this Profile.
                  </p>
                </div>
              </div>
            ...
            <div className="settingsContainer__main__contentContainer__content d-flex flex-row justify-content-between align-items-center">
              <div className="d-flex flex-row align-items-center gap-2 flex-grow-1">
                ...
                <div className="d-flex flex-column">
                  ...
                  <p>
                    Edit maturity rate and title restrictions
                  </p>
                </div>
              </div>
