...
import { useSetDeleteUserOptionMutation } from "../../../../service/redux/API/firebaseDB";
import { useNavigate } from "react-router-dom";

const DeleteUserOptionBtn = ({ index }) => {
  const [triggerDeleteUserOption, { isLoading }] = useSetDeleteUserOptionMutation();
  ...
  return (
    <button onClick={handleClick} className="deleteProfileBtn d-flex flex-row gap-2 justify-content-center align-items-center">
